...
//                $wpdb->query($sql_2);
                //                $wpdb->prepare($wpdb->query("INSERT INTO `" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `ordering`, `published`, `published_in_sl_width` ) VALUES ( '', '%s', '', '', '', 'par_TV', 2, '1' )", $row->id ));
	     }
	   }
...
//( '".$post_id_1->post_title."', '".$row->id."', '".$descnohtmlnoq1."', '".$post_image ."', '".$posturl."', 'image', 'on', '0', '1', '1' )";
//
//      $wpdb->query($sql_posts);
    $wpdb->query($wpdb->prepare("INSERT INTO `" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `sl_type`, `link_target`, `ordering`, `published`, `published_in_sl_width` ) VALUES ( '%s', '%s', '%s', '%s', '%s', 'image', 'on', '0', '1', '1' )", $post_id_1->post_title,$row->id, $descnohtmlnoq1, $post_image, $posturl ));
...
function popup_video($id)
{
	 ...
	 if(isset($_POST["huge_it_add_video_input"])) { 
		$youtubeviminsert = $_POST["huge_it_add_video_input"];
	  ...
	  if(isset($_POST["huge_it_add_video_input"])){
              ...
              if(isset($youtubeinsert[1])){
                  $sql_video = $wpdb->query($wpdb->prepare("INSERT INTO `" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `sl_type`, `link_target`, `ordering`, `published`, `published_in_sl_width` )"
                          . "VALUES ( '%s', '%s', '%s', '%s', '%s', 'video', '%s', '0', '1', '1' )", $_POST["show_quality"], $id, $_POST["show_volume"], $_POST["huge_it_add_video_input"], $_POST["show_controls"], $_POST["show_info"] ));
                  
//                  $sql_video = "INSERT INTO
//`" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `sl_type`, `link_target`, `ordering`, `published`, `published_in_sl_width`) VALUES
//( '".$_POST["show_quality"]."', '".$id."', '".$_POST["show_volume"]."', '".$_POST["huge_it_add_video_input"]."', '".$_POST["show_controls"]."', 'video', '".$_POST["show_info"]."', '0', '1', '1' )";
              }
	     if(isset($vimeoinsert[1])){
		
                  $sql_video = $wpdb->query($wpdb->prepare("INSERT INTO `" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `sl_type`, `link_target`, `ordering`, `published`, `published_in_sl_width` )"
                          . "VALUES ( '%s', '%s', '%s', '%s', '%s', 'video', '%s', '0', '1', '1' )", $_POST["show_quality"], $id, $_POST["show_volume"], $_POST["huge_it_add_video_input"], $_POST["show_controls"], $_POST["show_quality_vim"] ));
                  
//	  	$sql_video = "INSERT INTO 
//`" . $table_name . "` ( `name`, `slider_id`, `description`, `image_url`, `sl_url`, `sl_type`, `link_target`, `ordering`, `published`, `published_in_sl_width`) VALUES
//( '".$_POST["show_quality"]."', '".$id."', '".$_POST["show_volume_v"]."', '".$_POST["huge_it_add_video_input"]."', '".$_POST["show_controls"]."', 'video', '".$_POST["show_quality_vim"]."', '0', '1', '1' )";
                }
...
function removeslider($id)
{
	...
	global $wpdb;
        //$sql_remov_tag = "DELETE FROM ".$wpdb->prefix."huge_itslider_sliders WHERE id = $id";
...
{	
	...
	$script_cat = preg_replace('#<script(.*?)>(.*?)</script>#is', '', stripslashes($_POST["content"]));
		 ...
		 $wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix."huge_itslider_sliders SET  show_thumb = '%s'  WHERE ID = %d", $_POST["show_thumb"], $id));      /*dobavka*/
