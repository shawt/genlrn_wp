...
if (!class_exists('Wf_WooCommerce_Packing_List')) {
    ...
    class Wf_WooCommerce_Packing_List {
        ...
        function __construct() {
            ...
            add_action('woocommerce_email_after_order_table', array($this, 'wf_email_print_invoice'));
        ...
        public function wf_print_invoice_welcome() {
            ...
            wp_safe_redirect(add_query_arg(array('page' => 'wf_woocommerce_packing_list'), admin_url('admin.php')));
        }
            ...
            foreach ($orders as $order_id) {
                ...
                if (!empty($create_order_packages)) {
                    foreach ($create_order_packages as $order_package_id => $order_package) {
                        ...
                        $pdf_invoice_packinglist->order_date(date("d-m-Y", strtotime((WC()->version < '2.7.0') ? $order->order_date : $order->get_date_created())));
                        $ship_from_address = $this->wf_shipment_label_get_from_address();
                        $pdf_invoice_packinglist->from_address($ship_from_address);
        ...
        function woocommerce_packinglist_create_box_content() {
            ...
            <?php 
                ...
                $invoice_no = get_post_meta($order_id, 'wf_invoice_number', true);
                    
            echo '<font style="padding-left:5px;">Invoice Number:</font><b>' .$invoice_no. '</b>'; ?>
            <table >
                <tr>
                    <td><a class="button tips wf-packing-list-link" target="_blank" style="width:100%;" data-tip="<?php esc_attr_e('Print Invoice', 'wf-woocommerce-packing-list'); ?>" href="<?php echo wp_nonce_url(admin_url('?print_packinglist=true&post=' . $order_id . '&type=print_invoice'), 'print-packinglist'); ?>"><img src="<?php
                ...
                <tr>
                    <td><a class="button tips wf-packing-list-link" target="_blank" style="width:100%;" data-tip="<?php esc_attr_e('Print Packing List', 'wf-woocommerce-packing-list'); ?>" href="<?php echo wp_nonce_url(admin_url('?print_packinglist=true&post=' . $order_id . '&type=print_packing_list'), 'print-packinglist'); ?>"><img src="<?php
                            echo $this->wf_packinglist_get_plugin_url() . '/assets/images/Label-print-icon.png'; //exit();
                            ?>" alt="<?php esc_attr_e('Print Packing List', 'wf-woocommerce-packing-list'); ?>" width="14">  <?php _e(' Packing List', 'wf-woocommerce-packing-list'); ?></a>
                    </td>
                </tr>
                <tr>
                    <td><a class="button tips wf-packing-list-link" target="_blank" style="width:100%;" data-tip="<?php esc_attr_e('Print Shipping Label', 'wf-woocommerce-packing-list'); ?>" href="<?php echo wp_nonce_url(admin_url('?print_packinglist=true&post=' . $order_id . '&type=print_shipment_label'), 'print-packinglist'); ?>"><img  src="<?php
                            echo $this->wf_packinglist_get_plugin_url() . '/assets/images/Label-print-icon.png'; //exit();
                            ?>" alt="<?php esc_attr_e('Print Shipping Label', 'wf-woocommerce-packing-list'); ?>" width="14">  <?php _e(' Shipping Label', 'wf-woocommerce-packing-list'); ?></a>
                    </td>
                </tr>
                <tr>
                    <td><a class="button tips wf-packing-list-link" target="_blank" style="width:100%;" data-tip="<?php esc_attr_e('Print Delivery Note', 'wf-woocommerce-packing-list'); ?>" href="<?php echo wp_nonce_url(admin_url('?print_packinglist=true&post=' . $order_id . '&type=print_delivery_note'), 'print-packinglist'); ?>"><img src="<?php
                            echo $this->wf_packinglist_get_plugin_url() . '/assets/images/Label-print-icon.png'; //exit();
                            ?>" alt="<?php esc_attr_e('Print Delivery Note', 'wf-woocommerce-packing-list'); ?>" width="14">  <?php _e(' Delivery Note', 'wf-woocommerce-packing-list'); ?></a>
                    </td>
                </tr>

                <tr>
                    <td><a class="button tips wf-link" style="width:100%;;" data-tip="<?php esc_attr_e('Download Shipping Label', 'wf-woocommerce-packing-list'); ?>" href="<?php echo wp_nonce_url(admin_url('?print_packinglist=true&post=' . $order_id . '&type=download_shipment_label'), 'print-packinglist'); ?>"><img src="<?php
                                                                                                                                                                                                                                                                                                                              echo $this->wf_packinglist_get_plugin_url() . '/assets/images/pdf-icon.png'; //exit();
                                                                                                                                                                                                                                                                                                                              ?>" alt="<?php esc_attr_e('Download Shipping Label', 'wf-woocommerce-packing-list'); ?>" width="14">  <?php _e(' Shipping Label', 'wf-woocommerce-packing-list'); ?></a>
                    </td>
                </tr>
        ...
        function wf_packinglist_admin_scripts($hook) {
            ...
            wp_localize_script('wf_common', 'wf_common_params', array('ajaxurl' => admin_url('admin-ajax.php'),));
        }
        ...
        function woocommerce_packinglist_order_items_table($order, $show_price = FALSE) {
            ...
            foreach ($order as $id => $item) {
                ...
                if (($item['variation_id'] != '') && empty($attachment[0])) {
                     ...
                     $prent=wp_get_post_parent_id($item['variation_id'] );
                        $var_image_id = ($item['variation_id'] != '') ? get_post_thumbnail_id($item['variation_id']) : '';
                        $image_id = ($var_image_id == '') ? get_post_thumbnail_id($prent) : $var_image_id;
                        $attachment = wp_get_attachment_image_src($image_id);
                }
        ...
        function wf_shipment_label_get_to_address($order) {
            ...
            if ($_GET['type'] == 'print_shipment_label') {
                if (get_post_meta($order_id, '_wcmspackage', true)) {
        ...
        public function wf_email_print_invoice($order) {
            $my_wc_order = $order;
            if (get_class($order) == 'WC_Order') {
                $order = ( WC()->version < '2.7.0' ) ? new WC_Order($order) : new wf_order($order);
                if ('completed' === $my_wc_order->get_status()) {
                    $this->wf_send_invoice_attachment($my_wc_order, 'print_invoice');
                }
            }
        }

        public function wf_send_invoice_attachment($order, $action) {
            ob_start();
            $content1 = '';
            $content1 .= ob_get_clean();
            $attachments = array();
            ...
            ob_start();
            if ($action === 'print_invoice' && $order_status === 'completed') {
                include $this->wf_packinglist_template('dir', 'wf-invoice-pdf-template.php') . 'wf-invoice-pdf-template.php';
                ...
                if ($woocommerce_wf_add_invoice_in_mail == "Yes") {
                    ...
                    $active_invoice_template = get_option('wf_invoice_active_key');
                    $active_invoice_template = isset($active_invoice_template) ? $active_invoice_template . '.php' : 'wf_invoice_template_1.php';
                    include $this->wf_packinglist_template('dir', 'wf-invoice-pdf-template.php') . '/pdf-templates/' . $active_invoice_template;
                    if (!@include $this->wf_packinglist_template('dir', 'wf-invoice-pdf-template.php') . '/pdf-templates/' . $active_invoice_template) {
                        include $this->wf_packinglist_template('dir', 'wf-invoice-pdf-template.php') . '/pdf-templates/wf_invoice_template_1.php';
                    }

                    $dompdf->set_option('isHtml5ParserEnabled', true);
                    $dompdf->loadHtml($wf_invoice_pdf_template);
                    ...
                    $dompdf->render();
                    file_put_contents($upload_dir . '/invoice.pdf', $dompdf->output());
                    $attachments = array($upload_dir . '/invoice.pdf');
                }
            }
